...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // fetch data from database and check username and password is correct or not if correct then user should go to welcome page
...
<body>
    ...
    <!-- create a success msg and error msg -->
    <?php
    if ($loginAlert) {
